...
export function applyBotdockProviderConfig(cfg: OpenClawConfig): OpenClawConfig {
...
export function applyBotdockConfig(cfg: OpenClawConfig): OpenClawConfig {
  return applyAgentDefaultModelPrimary(
    applyBotdockProviderConfig(cfg),
    BOTDOCK_DEFAULT_MODEL_REF,
  );
}
