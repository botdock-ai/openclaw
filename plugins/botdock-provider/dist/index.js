...
import { buildLiveBotdockProvider, buildStaticBotdockProvider, } from './provider-catalog.js';
import { getBotdockModelCapabilities, loadAllBotdockModels, loadBotdockModelCapabilities, } from './botdock-capabilities-cache.js';
import { BOTDOCK_BASE_URL, BOTDOCK_DEFAULTS } from './botdock-models.js';
const PROVIDER_ID = 'botdock';
function buildDynamicBotdockModel(ctx) {
        ...
        api.registerProvider({
            ...
            auth: [
                createProviderApiKeyAuthMethod({
                    ...
                    applyConfig: (cfg) => applyBotdockConfig(cfg),
                    wizard: {
            ...
            resolveDynamicModel: (ctx) => buildDynamicBotdockModel(ctx),
